...
ax0.annotate(s=p1_iter[0], xy=(p1_turn[0], p1_iter[0]), color='b')
ax0.annotate(s=p1_iter[-1], xy=(p1_turn[-1], p1_iter[-1]), color='b')

ax0.plot(list(range(turns)), [p1_iter_average] * turns, '-.', color='#1f77b4')
ax0.annotate(s=round(p1_iter_average, 2), xy=(1, p1_iter_average), color='b')

ax0.plot(p2_turn, p2_iter, lw=3, color='#ff7f0e')
ax0.annotate(s=p2_iter[0], xy=(p2_turn[0], p2_iter[0]), color='r')
ax0.annotate(s=p2_iter[-1], xy=(p2_turn[-1], p2_iter[-1]), color='r')

ax0.plot(list(range(turns)), [p2_iter_average] * turns, '-.', color='#ff7f0e')
ax0.annotate(s=round(p2_iter_average, 2), xy=(turns - 2, p2_iter_average), color='r')
...
ax0.annotate(s=round(p1_time[0], 3), xy=(p1_time[0], p1_time[0]), color='b')
ax0.annotate(s=round(p1_time[-1], 3), xy=(p1_turn[-1], p1_time[-1]), color='b')

ax0.plot(list(range(turns)), [p1_time_average] * turns, '-.', color='#1f77b4')
ax0.annotate(s=round(p1_time_average, 3), xy=(1, p1_time_average), color='b')

ax0.plot(p2_turn, p2_time, lw=3, color='#ff7f0e')
ax0.annotate(s=round(p2_time[0], 3), xy=(p2_turn[0], p2_time[0]), color='r')
ax0.annotate(s=round(p2_time[-1], 3), xy=(p2_turn[-1], p2_time[-1]), color='r')

ax0.plot(list(range(turns)), [p2_time_average] * turns, '-.', color='#ff7f0e')
ax0.annotate(s=round(p2_time_average, 3), xy=(turns - 2, p2_time_average), color='r')
